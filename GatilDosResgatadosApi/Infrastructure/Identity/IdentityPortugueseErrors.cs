...
public class IdentityPortugueseMessages : IdentityErrorDescriber
{
    ...
    {
        return new IdentityError
        { Code = nameof(DuplicateUserName), Description = $"O e-mail '{userName}' já está sendo utilizado." };
    }
    ...
    public override IdentityError PasswordRequiresLower()
    {
        return new IdentityError
        {
            ...
            Description = "Senhas devem conter ao menos um caracter em minúsculo ('a'-'z')."
        };
    }
    ...
    public override IdentityError PasswordRequiresUpper()
    {
        return new IdentityError
        {
            ...
            Description = "Senhas devem conter ao menos um caracter em maiúsculo ('A'-'Z')."
        };
    }
}